...
echo '<div class="vertical-menu"></div><a href="/cgi-bin/MSU/block_barcode.sh" class="active"><b>Block any Barcode</b></a>'

echo '<div class="vertical-menu"></div><a href="/cgi-bin/MSU/unblock_barcode.sh" class="active"><b>Unblock any Barcode</b></a>'
