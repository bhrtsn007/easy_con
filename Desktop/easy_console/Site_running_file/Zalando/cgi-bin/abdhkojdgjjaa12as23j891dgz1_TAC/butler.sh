...
echo  '<div class="vertical-menu"></div><a href="/cgi-bin/butler/get_all_pause_butler.sh" class="active"><b>Get All Paused Butlers</b></a>'
...
echo '<div class="vertical-menu"></div><a href="/cgi-bin/butler/remote_update.sh" class="active"><b>Remote update for Butler</b></a>'
